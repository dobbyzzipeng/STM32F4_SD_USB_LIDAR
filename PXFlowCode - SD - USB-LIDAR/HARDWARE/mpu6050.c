...
void Offset_Check(unsigned short buff[],OFFSET *offset)
{
	offset->AX_Offset = buff[0];
	offset->AY_Offset = buff[1];
	offset->AZ_Offset = buff[2];
	
	offset->GX_Offset = buff[3];
	offset->GY_Offset = buff[4];
	offset->GZ_Offset = buff[5];	
}
